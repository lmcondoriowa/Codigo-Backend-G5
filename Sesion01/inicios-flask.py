...
def bienvenido():
    return 'Te doy la bienvenido a mi API'

@app.route('/bienvenido/home')
def bienvenido_home():
    # solamente podemos retornar los siguientes tipos de datos: strings, tupla y diccionarios
    return 'Te doy la bienvenido a mi API home'

if __name__ == '__main__':
    # para que cada vez que nosotros hagamos algun cambio en cualquier archivo del proyecto y se reinicie automaticamente entonces deberemos indicar el parametro debug con el valor de True (cuyo valor por defecto es False)
    # port > cambiara el puerto donde escuchara 
